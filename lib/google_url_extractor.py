#!/usr/bin/env python3
# LICENSE : MIT
# AUTHOR  : https://github.com/deepseagirl
# SOURCE  : https://github.com/deepseagirl/degoogle
#
# << edited for block-fake-pdf-sites >>
# LIMITATIONS : Google does not allow scrape without API
...
class dg():
    ...
    with open("output/domains_without_subdomain.txt") as domains: junk_strings = [line.rstrip() for line in domains] + ['facebook.com/', 'pinterest.com/', 'quora.com/', 'youtube.com/', 'youtu.be/', 'tr.wikipedia.org', 'tr.m.wikipedia.org']
    ...
    def search(self, page):
        ...
        url = f"https://google.com.tr/search?start={pg}&tbs=qdr:{self.time_window}&q={normalized_query}&filter=0"
